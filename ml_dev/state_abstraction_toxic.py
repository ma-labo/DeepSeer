...
parser.add_argument('--test_file', dest='test_file', default=None, help='test_set')
...
if __name__ == '__main__':
    ...
    if args.test_file:
        X_test = pd.read_csv(args.test_file, index_col="id")

        test_dataset = CommentDataset(df=X_test, tokenizer=tokenizer, max_length=max_sentence_length,
                                      data_col="comment_text", target="toxicity", is_testing=False)
